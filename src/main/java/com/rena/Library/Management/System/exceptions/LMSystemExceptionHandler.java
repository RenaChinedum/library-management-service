...
@ControllerAdvice
public class LMSystemExceptionHandler {

    @ExceptionHandler(LMSystemException.class)
    public ResponseEntity<UnifiedResponse<?>> customExceptionHandle(LMSystemException ex) {
